...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference("Code.count") do
      post codes_url, params: { code: { chapter: @code.chapter, description: @code.description, name: @code.name, section: @code.section } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { chapter: @code.chapter, description: @code.description, name: @code.name, section: @code.section } }
